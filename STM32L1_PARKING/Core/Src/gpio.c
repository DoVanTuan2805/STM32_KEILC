...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LD2_Pin|PUL2_Pin|DIR2_Pin|IN1_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = TC_15_Pin|TC_16_Pin|TC_13_Pin|TC_14_Pin
                          |TC_12_Pin|TC_3_Pin|TC_2_Pin|TC_1_Pin;
  ...
  /*Configure GPIO pins : PBPin PBPin PBPin PBPin
                           ...
                           PBPin */
  GPIO_InitStruct.Pin = TC_8_Pin|TC_7_Pin|TC_6_Pin|TC_11_Pin
                          |TC_10_Pin|TC_9_Pin|IN_B_Pin|CTHT_PLATE_IN_Pin
                          |CTHT_PLATE_OUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  GPIO_InitStruct.Pin = TC_5_Pin|TC_4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
