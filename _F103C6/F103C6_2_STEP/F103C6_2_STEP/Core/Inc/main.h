...
#define DIR_X_Pin GPIO_PIN_11
#define DIR_X_GPIO_Port GPIOA
#define STEP_X_Pin GPIO_PIN_12
#define STEP_X_GPIO_Port GPIOA
#define MS3_X_Pin GPIO_PIN_15
#define MS3_X_GPIO_Port GPIOA
#define MS2_X_Pin GPIO_PIN_3
#define MS2_X_GPIO_Port GPIOB
#define MS1_X_Pin GPIO_PIN_4
